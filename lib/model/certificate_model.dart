...
List<CertificateModel> certificateList = [
  CertificateModel(
    name: 'lbl_cert_name_accountant',
    organization: 'lbl_cert_org_accountant',
    date: '45139',
    skills: 'lbl_cert_skill_accountant',
    credential: '',
  ),
  CertificateModel(
    name: 'lbl_cert_name_designer',
    organization: 'lbl_cert_org_designer',
    date: '45139',
    skills: 'lbl_cert_skill_designer',
    credential: '1234.mn',
  ),
  CertificateModel(
    name: 'lbl_cert_name_java',
    organization: 'lbl_cert_org_1234',
    date: '45139',
    skills: 'lbl_cert_skill_java',
    credential: '1234.mn',
  ),
  CertificateModel(
    name: 'lbl_cert_name_react',
    organization: 'lbl_cert_org_1234',
    date: '45139',
    skills: 'lbl_cert_skill_react',
    credential: '1234.mn',
  ),
  CertificateModel(
    name: 'lbl_cert_name_ts',
    organization: 'lbl_cert_org_1234',
    date: '45139',
    skills: 'lbl_cert_skill_ts',
    credential: '1234.mn',
  ),
  CertificateModel(
    name: 'lbl_cert_name_aws',
    organization: 'lbl_cert_org_1234',
    date: '45139',
    skills: 'lbl_cert_skill_aws',
    credential: '1234.mn',
  ),
  CertificateModel(
    name: 'lbl_cert_name_docker',
    organization: 'lbl_cert_org_1234',
    date: '45139',
    skills: 'lbl_cert_skill_docker',
    credential: '',
  ),
  // CertificateModel(
